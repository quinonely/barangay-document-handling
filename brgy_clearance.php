...
<head>
  <link rel="shortcut icon" type="image/png" href="img/seal_icon.png">
    ...
    <title>Barangay Clearance Fill Form | Barangay 837</title>
...
?>
    ...
    <div id="breadcrumb" class="hoc clear">
     <h6 class="heading" style="font-size:45px;">Barangay Clearance</h6>
  </div>
</div>
</div>
 	<!-- ################################################################################################ -->
...
<main class="hoc container clear">
      ...
      <h2 class="heading underline font-x2" style="font-size:40px;">Barangay Clearance Fill Form</h2>
      <br> </br>
      <p class="centerpara">Please fill the form accordingly below.</p>
<br> </br>
<form id="clearance" action="services/brgy_clearance.php" method="POST">
...
<script>
  function clearInputs() {
    document.getElementById("clearance").reset();
  }
</script>
 <script>
const checkbox = document.getElementById("data");
const form = document.getElementById("clearance");
