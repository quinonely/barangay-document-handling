...
<head>
    ...
    <title>Add Admin | Barangay 837</title>
...
if(!($_SESSION['acc_privilege'] == 'Admin')){
    ...
    <div id="breadcrumb" class="hoc clear">
     <h6 class="heading" style="font-size:45px;">Add Admin</h6>
  </div>
</div>
</div>
 	<!-- ################################################################################################ -->
...
<main class="hoc container clear">
      ...
      <h2 class="heading underline font-x2" style="font-size:40px;">Add Admin</h2>
      <br> </br>
      <p class="centerpara">Please fill the form accordingly below.</p>
<br> </br>
<form id="admin" action="services/add_admin.php" method="post">
        <?php
        if(isset($error)){
...
<table class="tableform">
        ...
        <td class="tableform">
          ...
          <br>
          <input type="text" id="number" name="number" placeholder="Contact Number" class="textminquiry" required></td>
        <td class="tableform">
