...
<meta charset="utf-8">
  <link rel="shortcut icon" type="image/png" href="img/seal_icon.png">
    ...
    <title>Barangay Certificate Fill Form | Barangay 837</title>
...
window.onload = function() {
  alert("Please ensure that you are residing 6 months in the barangay.");
};
</script>
...
?>
    ...
    <div id="breadcrumb" class="hoc clear">
     <h6 class="heading" style="font-size:45px;">Barangay Certificate</h6>
  </div>
</div>
</div>
 	<!-- ################################################################################################ -->
...
<main class="hoc container clear">
      ...
      <h2 class="heading underline font-x2" style="font-size:40px;">Barangay Certificate Fill Form</h2>
      <br> </br>
      <p class="centerpara">Please fill the form accordingly below.</p>
<br> </br>
<form id="certificate" action="services/brgy_certificate.php" method="POST">
