...
<link rel="shortcut icon" type="image/png" href="img/seal_icon.png">
    ...
    <title>Denied Documents | Barangay 837</title>
...
<div class="wrap-border">
    <br>
    <center>
      <h2 class="heading font-x2" style="font-size:40px;">All Denied Documents</h2>
    </center>
...
$sql = "SELECT * from doc_req INNER JOIN documents ON doc_req.doc_id = documents.doc_id WHERE doc_req.status='Denied'";
